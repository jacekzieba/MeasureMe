...
@MainActor
final class HealthIndicatorDetailSnapshotTests: IsolatedPreferencesSnapshotTestCase {
    ...
    private func assertDetailSnapshot<V: View>(named name: String, testName: String, view: V) async throws {
        ...
        assertSnapshot(of: vc, as: .image(precision: 0.99, perceptualPrecision: 0.98), named: name, record: shouldRecord, testName: testName)
    }
}
