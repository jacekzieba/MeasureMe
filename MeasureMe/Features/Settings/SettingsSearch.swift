...
enum SettingsSearchCatalog {
    static var items: [SettingsSearchItem] {
        [
            ...
            SettingsSearchItem(route: .experience, title: AppLocalization.string("Animations and haptics"), subtitle: AppLocalization.string("Animations and haptics"), keywords: ["animations", "haptics", "vibration", "motion", "animacje", "haptyka", "wibracje", "dźwięk"]),
